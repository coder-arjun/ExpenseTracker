...
namespace ExpenseTracker.Migrations
{
    ...
    [Migration("20260405074658_AddDisplayUserId")]
    partial class AddDisplayUserId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpenseTracker.Models.Domain.Budget", b =>
                {
                    ...
                    b.HasIndex("UserId", "YearMonth", "Category")
                        .IsUnique()
                        .HasFilter("[UserId] IS NOT NULL AND [Category] IS NOT NULL");
